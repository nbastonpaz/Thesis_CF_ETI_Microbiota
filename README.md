...
- For metagenomic, metaproteomic, and SCFA quantification analysis in Chapter II:
...
In this repository you will find the data, metadata, and R scripts for the following analysis.
Microbiome, metaproteomic, metabolomic, and ARG analysis were performed **separately for fecal and sputum samples** to account for the distinct microbial and physiological environments of the gut and lungs.
...
4. **Functional analysis**
   - Metaproteomic analysis<sup>*</sup>
     ...
     - Protein–protein interaction and functional enrichment analysis of human proteins using STRING (version 12.0) (https://string-db.org/).  
...
6. **Longitudinal genomic analysis of _Pseudomonas aeruginosa_**
   ...
   - Phylogenetic and pairwise genomic variant analysis.
